...
// Bundle is the internationalization translation bundle that manages multi-language text loading and lookup.
type Bundle struct {
	data map[string]map[string]string
}

// NewBundle creates a translation bundle, loading from the embedded locale JSON files.
...
// T translates text for the specified language, supporting format parameters.
...
// Ef translates text and wraps it as an error.
...
// DetectLang detects the language by checking CLI parameters, config, and environment variables in order.
