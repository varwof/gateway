...
// Bundle is the internationalization translation bundle, managing multi-language text loading and querying.
type Bundle struct {
...
// DetectLang detects the language by CLI argument, config, and environment variable in order.
